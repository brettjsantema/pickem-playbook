...
const platforms = [
  ...
  { name: 'CoinWizard',    logo: '/images/logos/coinwizard.svg',    logoBg: '#7C01D1', welcomeText: 'Free SC + Daily Rewards', link: 'https://www.coinwizardgames.com/referral/K3N55EE5LG' },
  { name: 'Legendz',       logo: '/images/logos/legendz.webp',      logoBg: '#161A26', welcomeText: 'Big Welcome Offers',   link: 'https://www.legendz.com/?referred_by_id=1021969' },
  { name: 'Moozi',         logo: '/images/logos/moozi.png',         welcomeText: 'Free SC on Signup',    link: 'https://moozi.com/signup?referral_code=2611347992' },
  ...
  // Row 3 - B2 sites
  { name: 'McLuck',        logo: '/images/logos/mcluck.png',        welcomeText: 'Big Welcome Offers',   link: 'https://www.mcluck.com/lp/raf?r=81a258e5%2F2541552073',        b2Guide: true, isNew: true, b2Features: true },
  { name: 'PlayFame',      logo: '/images/logos/playfame.png',      welcomeText: 'Big Welcome Offers',   link: 'https://www.playfame.com/lp/raf?r=51c24eac%2F2547101221',       b2Guide: true, isNew: true, b2Features: true },
  { name: 'HelloMillions', logo: '/images/logos/hellomillions.webp',welcomeText: 'Big Welcome Offers',   link: 'https://www.hellomillions.com/lp/raf?r=5459cd73%2F2553383889',  b2Guide: true, isNew: true, b2Features: true },
  { name: 'SpinBlitz',     logo: '/images/logos/spinblitz.png',     welcomeText: 'Big Welcome Offers',   link: 'https://www.spinblitz.com/lp/raf?r=3d210d80%2F2565575372',       b2Guide: true, isNew: true, b2Features: true },
  // Rest
